...
setwd("C:\\Users\\SamSw\\OneDrive\\Documents\\Genes and genomes\\LAB_NEN_ODN.clean_BI.ann.3mbChr5.vcf.gz.tbi")
...
vcf <- read.vcfR("LAB_NEN_ODN.clean_BI.ann.3mbChr5.vcf")   #read in all data
